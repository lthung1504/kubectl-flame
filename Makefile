...
push_to_docker_hub:
	...
	docker tag kubectl-flame-asyncprofiler2:v0.0.3 thanhhungle/kubectl-flame-asyncprofiler2:v0.0.3
	docker push thanhhungle/kubectl-flame-asyncprofiler2:v0.0.3
